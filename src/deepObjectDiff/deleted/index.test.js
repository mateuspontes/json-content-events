...
describe('.deletedDiff', () => {
  ...
  describe('recursive case', () => {
    describe('object', () => {
      ...
      test('returns the object when deleted from right hand side root', () => {
        expect(deletedDiff({ a: 1, b: { c: 2 } }, { a: 1 })).toEqual({
          b: { c: 2 },
        })
      })

      test('returns the object when deeply deleted from right hand side', () => {
        expect(
          deletedDiff(
            { a: { b: 1 }, c: 2, d: { e: 100 } },
            { a: { b: 1 }, c: 2, d: {} }
    ...
    describe('object create null', () => {
      test('returns keys when deleted from right hand side root', () => {
